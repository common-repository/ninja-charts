...
use NinjaCharts\Framework\Support\JsonableInterface;
use NinjaCharts\Framework\Support\ArrayableInterface;
use NinjaCharts\Framework\Database\Orm\Relations\Pivot;
use NinjaCharts\Framework\Database\Orm\Relations\HasOne;
use NinjaCharts\Framework\Database\Orm\ModelHelperTrait;
use NinjaCharts\Framework\Database\Orm\Relations\MorphTo;
use NinjaCharts\Framework\Database\Orm\Relations\HasMany;
use NinjaCharts\Framework\Database\Orm\Relations\MorphOne;
use NinjaCharts\Framework\Database\Orm\Relations\MorphMany;
use NinjaCharts\Framework\Database\Orm\Relations\Relation;
use NinjaCharts\Framework\Database\Orm\Relations\BelongsTo;
use NinjaCharts\Framework\Database\Orm\Relations\MorphToMany;
use NinjaCharts\Framework\Database\Orm\Relations\BelongsToMany;
use NinjaCharts\Framework\Database\Orm\Relations\HasManyThrough;
use NinjaCharts\Framework\Database\Query\Builder as QueryBuilder;
use NinjaCharts\Framework\Database\ConnectionResolverInterface as Resolver;
...
abstract class Model implements ArrayAccess, ArrayableInterface, JsonableInterface, JsonSerializable {
	 ...
	 *
	 * @var \NinjaCharts\Framework\Foundation\Dispatcher
	 */
	 ...
	 *
	 * @param  \NinjaCharts\Framework\Database\Orm\ScopeInterface  $scope
	 * @return void
	 */
	 ...
	 *
	 * @param  \NinjaCharts\Framework\Database\Orm\ScopeInterface  $scope
	 * @return \NinjaCharts\Framework\Database\Orm\ScopeInterface|null
	 */
	 ...
	 *
	 * @return \NinjaCharts\Framework\Database\Orm\ScopeInterface[]
	 */
	 ...
	 * @return $this
	 *
	 * @throws \NinjaCharts\Framework\Database\Orm\MassAssignmentException
	 */
	 ...
	 *
	 * @param  array  $columns
	 * @return \NinjaCharts\Framework\Database\Orm\Collection|static[]
	 */
	 ...
	 * @param  mixed  $id
	 * @param  array  $columns
	 * @return \NinjaCharts\Framework\Support\Collection|static|null
	 */
	 ...
	 * @param  mixed  $id
	 * @param  array  $columns
	 * @return \NinjaCharts\Framework\Support\Collection|static
	 */
	 ...
	 * @return \NinjaCharts\Framework\Support\Collection|static
	 *
	 * @throws \NinjaCharts\Framework\Database\Orm\ModelNotFoundException
	 */
	 ...
	 *
	 * @param  array|string  $relations
	 * @return \NinjaCharts\Framework\Database\Orm\Builder|static
	 */
	 ...
	 * @return \NinjaCharts\Framework\Database\Orm\Relations\HasOne
	 */
	 ...
	 * @param  string  $id
	 * @param  string  $localKey
	 * @return \NinjaCharts\Framework\Database\Orm\Relations\MorphOne
	 */
	 ...
	 * @return \NinjaCharts\Framework\Database\Orm\Relations\BelongsTo
	 */
	 ...
	 * @param  string  $type
	 * @param  string  $id
	 * @return \NinjaCharts\Framework\Database\Orm\Relations\MorphTo
	 */
	 ...
	 * @param  string  $foreignKey
	 * @param  string  $localKey
	 * @return \NinjaCharts\Framework\Database\Orm\Relations\HasMany
	 */
	 ...
	 * @return \NinjaCharts\Framework\Database\Orm\Relations\HasManyThrough
	 */
	 ...
	 * @param  string  $id
	 * @param  string  $localKey
	 * @return \NinjaCharts\Framework\Database\Orm\Relations\MorphMany
	 */
	 ...
	 * @param  string  $otherKey
	 * @param  string  $relation
	 * @return \NinjaCharts\Framework\Database\Orm\Relations\BelongsToMany
	 */
	 ...
	 * @param  string  $otherKey
	 * @param  bool    $inverse
	 * @return \NinjaCharts\Framework\Database\Orm\Relations\MorphToMany
	 */
	...
	protected function getRelationshipFromMethod($key, $camelKey)
	{
		...
		if ( ! $relations instanceof Relation)
		{
			throw new LogicException('Relationship method must return an object of type '
				. 'NinjaCharts\Framework\Database\Orm\Relations\Relation');
		}
	 ...
	 *
	 * @return \NinjaCharts\Framework\Foundation\Dispatcher
	 */
	 ...
	 *
	 * @param  \NinjaCharts\Framework\Foundation\Dispatcher  $dispatcher
	 * @return void
	 */
